    ...
    public class GetCompetitivePricingForASINSample
    {
        ...
        public static void InvokeGetCompetitivePricingForASIN(MarketplaceWebServiceProducts service, GetCompetitivePricingForASINRequest request)
        {
            try 
            {
                ...
                Console.WriteLine("        GetCompetitivePricingForASINResponse");
                List<GetCompetitivePricingForASINResult> getCompetitivePricingForASINResultList = response.GetCompetitivePricingForASINResult;
                foreach (GetCompetitivePricingForASINResult getCompetitivePricingForASINResult in getCompetitivePricingForASINResultList)
                {
                    Console.WriteLine("            GetCompetitivePricingForASINResult");
                if (getCompetitivePricingForASINResult.IsSetASIN()) {
                    Console.WriteLine("        ASIN");
                    Console.WriteLine();
                    Console.WriteLine("                {0}",  getCompetitivePricingForASINResult.ASIN);
                    Console.WriteLine();
                } 
                if (getCompetitivePricingForASINResult.IsSetstatus()) {
                    Console.WriteLine("        status");
                    Console.WriteLine();
                    Console.WriteLine("                {0}",  getCompetitivePricingForASINResult.status);
                    Console.WriteLine();
                } 
                    ...
                    if (getCompetitivePricingForASINResult.IsSetError())
                    {
                        ...
                        Error  error = getCompetitivePricingForASINResult.Error;
                        if (error.IsSetType())
                        {
