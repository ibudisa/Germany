...
namespace MarketplaceWebServiceProducts.Samples
{
    ...
    public class ListMatchingProductsSample
    {
        ...
        public static void InvokeListMatchingProducts(MarketplaceWebServiceProducts service, ListMatchingProductsRequest request)
        {
            try 
            {
                ...
                Console.WriteLine("        ListMatchingProductsResponse");
                if (response.IsSetListMatchingProductsResult())
                {
                    Console.WriteLine("            ListMatchingProductsResult");
