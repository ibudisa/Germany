...
namespace MarketplaceWebServiceProducts.Samples
{
    ...
    public class GetMyPriceForSKUSample
    {
        ...
        public static void InvokeGetMyPriceForSKU(MarketplaceWebServiceProducts service, GetMyPriceForSKURequest request)
        {
            try 
            {
                GetMyPriceForSKUResponse response = service.GetMyPriceForSKU(request);
                ...
                Console.WriteLine("        GetMyPriceForSKUResponse");
                ...
                {
                    Console.WriteLine("            GetMyPriceForSKUResult");
                if (getMyPriceForSKUResult.IsSetSellerSKU()) {
                    Console.WriteLine("        SellerSKU");
                    Console.WriteLine();
                    Console.WriteLine("                {0}",  getMyPriceForSKUResult.SellerSKU);
                    Console.WriteLine();
                } 
                if (getMyPriceForSKUResult.IsSetstatus()) {
                    Console.WriteLine("        status");
                    Console.WriteLine();
                    Console.WriteLine("                {0}",  getMyPriceForSKUResult.status);
                    Console.WriteLine();
                } 
                    ...
                    if (getMyPriceForSKUResult.IsSetError())
                    {
                        Console.WriteLine("                Error");
                        Error  error = getMyPriceForSKUResult.Error;
                        if (error.IsSetType())
                        {
