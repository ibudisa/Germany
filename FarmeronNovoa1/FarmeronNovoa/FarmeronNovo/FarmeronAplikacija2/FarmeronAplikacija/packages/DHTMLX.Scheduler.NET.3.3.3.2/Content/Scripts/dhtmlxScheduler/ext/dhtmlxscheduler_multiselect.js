...
r(n),t.removeChild(l)})}},get_value:function(e,t,a){for(var n=[],i=e.getElementsByTagName("input"),r=0;r<i.length;r++)i[r].checked&&n.push(i[r].value);return n.join(",")},focus:function(e){}}});