...
(c) Dinamenta, UAB.
*/
Scheduler.plugin(function(e){if("undefined"!=typeof dataProcessor){var t=dataProcessor.prototype.init;dataProcessor.prototype.init=function(){t.apply(this,arguments);var e=this;this.attachEvent("onAfterUpdate",function(t,a,i,n){var r;r=e.obj.exists(i)?e.obj.item(i):{},"undefined"!=typeof r.$selected&&delete r.$selected,"undefined"!=typeof r.$template&&delete r.$template,e.callEvent("onLocalUpdate",[{sid:t,tid:i,status:a,data:r}])})},dataProcessor.prototype.applyChanges=function(e){var t=this,a=e.sid,i=e.tid,n=e.status,r=e.data;

switch(t.obj.isSelected(a)&&(r.$selected=!0),n){case"updated":case"update":case"inserted":case"insert":t.obj.exists(a)?(t.obj.isLUEdit(r)===a&&t.obj.stopEditBefore(),t.ignore(function(){t.obj.update(a,r),a!==i&&t.obj.changeId(a,i)})):(r.id=i,t.ignore(function(){t.obj.add(r)}));break;case"deleted":case"delete":t.ignore(function(){t.obj.exists(a)&&(t.obj.setUserData(a,"!nativeeditor_status","true_deleted"),t.obj.stopEditBefore(),t.obj.remove(a),t.obj.isLUEdit(r)===a&&(t.obj.preventLUCollision(r),t.obj.callEvent("onLiveUpdateCollision",[a,i,n,r])===!1&&t.obj.stopEditAfter()));

})}}}"undefined"!=typeof e&&(e.item=function(t){var a=this.getEvent(t);if(!a)return{};var i={};for(var n in a)i[n]=a[n];return i.start_date=e.date.date_to_str(e.config.api_date)(a.start_date),i.end_date=e.date.date_to_str(e.config.api_date)(a.end_date),i},e.update=function(t,a){var i=this.getEvent(t);for(var n in a)"start_date"!=n&&"end_date"!=n&&(i[n]=a[n]);var r=e.date.str_to_date(e.config.api_date);e.setEventStartDate(t,r(a.start_date)),e.setEventEndDate(t,r(a.end_date)),this.updateEvent(t)},e.remove=function(e){
